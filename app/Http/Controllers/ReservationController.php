...
class ReservationController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // If no similar reservation or pending reservation exists, proceed with creating the reservation
        ...
        $reservation->status = 'pending'; // Set the initial status to "pending"
        $reservation->save();
